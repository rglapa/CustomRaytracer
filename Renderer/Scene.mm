...
- (void)addCubeFaceWithCubeVertices:(float3 *)cubeVertices color:(vector_float3)color
                      i0:(uint16_t)i0
                      i1:(uint16_t)i1
                      i2:(uint16_t)i2
                      i3:(uint16_t)i3
...
- (NSArray <id <MTLResource>> *)resources {
    // The sphere interesection function uses the sphere origins and radii to check for
